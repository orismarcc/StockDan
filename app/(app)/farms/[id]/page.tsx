    ...
    <div>
      ...
      <div className="mb-6 flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
        ...
        <div className="flex flex-wrap items-center gap-2 sm:shrink-0">
          <Link href={`/farms/${id}/retirada`} className="flex-1 sm:flex-none">
            <button className="w-full sm:w-auto flex items-center justify-center gap-2 rounded-lg border border-green-600/40 bg-green-600/10 px-3 py-2.5 sm:py-2 text-sm font-medium text-green-400 hover:bg-green-600/20 hover:border-green-500/60 transition-colors">
              <svg className="h-4 w-4 shrink-0" viewBox="0 0 20 20" fill="currentColor">
