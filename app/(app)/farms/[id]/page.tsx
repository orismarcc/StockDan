    ...
    <div>
      ...
      <div className="mb-6 flex items-start justify-between gap-4">
        <div>
          <Link
            href="/dashboard"
            className="mb-3 flex items-center gap-2 text-sm text-gray-500 hover:text-gray-300 transition-colors"
          >
          ...
          <h1 className="text-2xl font-bold text-gray-100">{farm.name}</h1>
