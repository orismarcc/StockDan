  ...
  if (format === 'pdf') {
    ...
    if (sections.includes('by_insumo')) {
      ...
      autoTable(doc, {
        ...
        headStyles:         { fillColor: GREEN_DARK as RGB, textColor: WHITE as RGB, fontStyle: 'bold' },
        alternateRowStyles: { fillColor: GRAY050 as RGB },
        columnStyles: {
    ...
    if (sections.includes('by_talhao')) {
      ...
      autoTable(doc, {
        ...
        styles:             { fontSize: 9, cellPadding: 3, lineColor: GRAY200 as RGB, lineWidth: 0.2 },
        headStyles:         { fillColor: AMBER_DARK as RGB, textColor: WHITE as RGB, fontStyle: 'bold' },
        alternateRowStyles: { fillColor: GRAY050 as RGB },
        columnStyles: {
